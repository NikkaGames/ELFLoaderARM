...
1. Encrypt and compress the ARM64 ELF payload with [FileCompressor](https://github.com/NikkaGames/FileCompressor).
2. Convert the generated encrypted file to a C byte array with a file-to-hex converter such as [tomeko.net's file to hex tool](https://tomeko.net/online_tools/file_to_hex.php?lang=en).
